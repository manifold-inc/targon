...
TARGON (Bittensor Subnet 4) implements a redundant deterministic verification network that can be used to interpret and analyze ground truth sources and a query. 
...
```bash
docker-compose -f neuron/prover/docker-compose.yml up -d
```
...
optionally, you can edit the docker-compose.yml file to include the proving container, but you will need to edit the docker-compose.yml file and uncomment out the prover container. Otherwise you can run the prover with PM2.
...
```bash
docker-compose -f neuron/verifier/docker-compose.yml up -d
```
...
optionally, you can edit the docker-compose.yml file to include the verifier container, but you will need to edit the docker-compose.yml file and uncomment out the verifier container. Otherwise you can run the verifier with PM2.
