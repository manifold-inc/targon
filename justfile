...
miner:
  python neurons/miner.py --wallet.name miner --netuid 40 --wallet.hotkey new-miner0 --subtensor.network test --neuron.model_endpoint http://localhost:8000/v1 --nueron.api_key 1234
