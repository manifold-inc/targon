...
validator:
  python3 neurons/validator.py --wallet.name validator-testnet --netuid 40 --subtensor.network test --epoch-length 101 --logging.trace --autoupdate-off --mock --models.mode endpoint --models.endpoint https://targon.sybil.com/api/models
