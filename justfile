...
script script_name:
  python3 scripts/{{script_name}}.py --wallet.name validator --netuid 40 --subtensor.network test --neuron.model_endpoint http://localhost:9000/v1 --neuron.port 8080 --neuron.epoch_length 101 --logging.trace --database.url $DATABASE_URL
