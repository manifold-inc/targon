...
class WebCrawler:
    ...
    def submit(self, url, text, summary, embeddings):
        ...
        response = requests.post("https://us-central-02.db.sybil.com/v1/vector/submit", json=params, headers=headers)
    ...
    def crawl(self, url, depth, max_depth):
        ...
        if response.status_code == 200:
            ...
            # self.db_client.insert(url, text, "summary here", embeddings)
            print("inserted")
            new_links = []
